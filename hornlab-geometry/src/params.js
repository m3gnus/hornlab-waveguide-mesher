...
export function coerceConfigParams(params = {}) {
  ...
  for (const [key, value] of Object.entries(params)) {
    ...
    // Preserve structured values (nested profileSystem, _blocks, arrays)
    // — the MWG parser attaches these directly to parsed.params and
    // stringifying them destroys the nested shape.
